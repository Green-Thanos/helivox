...
export class CatalogsPageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.catalogData = {
      ...
      school: this.dta.getSchools(
        this.dta.getStates()[this.route.snapshot.params['state']],
      )[this.route.snapshot.params['school']],
    };
    ...
    this.subscription = this.route.params.subscribe((params: Params) => {
      (this.catalogData.catalog = this.dta.catalogs[params['catalog']]),
        ...
        (this.catalogData.school = this.dta.getSchools(
          this.dta.getStates()[params['state']],
        )[params['school']]);
    });
